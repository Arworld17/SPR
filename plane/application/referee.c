...
//void get_shoot_speed_limit_and_speed(uint16_t *speed_limit, uint16_t *speed)
//{
//    //*speed_limit = robot_state.shooter_heat0_cooling_limit;
//    *speed_limit = robot_state.shooter_id1_17mm_speed_limit;
