...
extern int n;
extern int speed_cut;//检测摩擦轮超速降速
...
//    osDelay(100);
//    draw_servo_bull_circle(send_id, receive_id, 1);
//    osDelay(100);
    draw_pitch(sender_id, receive_id, 1);
    osDelay(100);
    draw_pitch_number(sender_id, receive_id, 1);
    osDelay(100);
//    draw_speed_cut(sender_id, receive_id, 1);
//    osDelay(100);
//    draw_speed_cut_number(sender_id, receive_id, 1);
//    osDelay(100);
//    draw_capacity_tangle(sender_id, receive_id, 1);
//    osDelay(100);
...
void draw_chassis_mode_state(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    case CHASSIS_ZERO_FORCE:
        draw_init.grapic_data_struct.color = 3;
...
void draw_chassis_mode(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    draw_init.grapic_data_struct.layer = 1;
    draw_init.grapic_data_struct.color = 8;
    draw_init.grapic_data_struct.start_angle = FONT_SIZE; 
    ...
    memset(draw_init.data, 0, sizeof(draw_init.data));
    draw_init.grapic_data_struct.end_angle = 13; 
    draw_init.data[0] = 'C';
    draw_init.data[1] = 'H';
    draw_init.data[2] = 'A';
    draw_init.data[3] = 'S';
...
{
    tank->r = VERTICAL * 1.3;
    tank->angle = -(gimbal_control.gimbal_yaw_motor.relative_angle) - PI/12;
...
void draw_gimbal_relative_angle_tangle(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    draw_init.grapic_data_struct[0].color = 6;
    draw_init.grapic_data_struct[0].width = 6;
    draw_init.grapic_data_struct[0].start_x = gimbal_angle_center_x;
    draw_init.grapic_data_struct[0].start_y = gimbal_angle_center_y;
...
void draw_state_of_top_circle(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    draw_init.grapic_data_struct.width = 8;
...
void draw_capacity_char(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    draw_init.grapic_data_struct.layer = 1;
    draw_init.grapic_data_struct.color = 8;
    draw_init.grapic_data_struct.start_angle = 25; 
    ...
    memset(draw_init.data, 0, sizeof(draw_init.data));
    draw_init.grapic_data_struct.end_angle = 1; 
    draw_init.data[0] = '%';
...
{
    aim_dynamic->angle = (int)(gimbal_control.gimbal_pitch_motor.absolute_angle * 1000);
}
...
void cal_capacity(super_capacity_t *super_capacity)
{
    ...
    super_capacity->jindu = (uint16_t)(super_capacity->power_ratio * 330);
...
void draw_servo_bull(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
   ext_client_custom_character_t draw_init;
    ...
    draw_init.grapic_data_struct.end_angle = 5; //锟街凤拷锟斤拷锟斤拷
    draw_init.data[0] = 'S';
    draw_init.data[1] = 'E';
    draw_init.data[2] = 'R';
    draw_init.data[3] = 'V';
...
void draw_servo_bull_circle(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    draw_init.grapic_data_struct.layer = 1;
    draw_init.grapic_data_struct.start_x = LEFT_STATE_AREA_X + 220;
    draw_init.grapic_data_struct.start_y = LEFT_STATE_AREA_Y - 2 * LEFT_STATE_DY - 10;
    draw_init.grapic_data_struct.width = 8;
    draw_init.grapic_data_struct.radius = 20;
...
void draw_pitch(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    draw_init.grapic_data_struct.graphic_name[0] = 0;
    draw_init.grapic_data_struct.graphic_name[1] = 0;
    draw_init.grapic_data_struct.graphic_name[2] = 51;
    draw_init.grapic_data_struct.operate_tpye = op_type;
    draw_init.grapic_data_struct.graphic_tpye = 7;
    draw_init.grapic_data_struct.layer = 2;//图层怎么用
    draw_init.grapic_data_struct.color = 8;
    draw_init.grapic_data_struct.start_angle = FONT_SIZE; 

    draw_init.grapic_data_struct.width = 2;
    draw_init.grapic_data_struct.start_x = AIM_CENTER_X + 150;
    draw_init.grapic_data_struct.start_y = AIM_CENTER_Y + 120;
    draw_init.grapic_data_struct.end_x = 0;
    draw_init.grapic_data_struct.end_y = 0;
    draw_init.grapic_data_struct.radius = 0;
    ...
    draw_init.grapic_data_struct.end_angle = 6; //锟街凤拷锟斤拷锟斤拷
    draw_init.data[0] = 'P';
    draw_init.data[1] = 'I';
    draw_init.data[2] = 'T';
    draw_init.data[3] = 'C';
    draw_init.data[4] = 'H';
    draw_init.data[5] = ':';
    //draw_init.data[6] = aim_dynamic.angle;
...
void draw_pitch_number(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    init_struct.grapic_data_struct.graphic_name[0] = 0;
    init_struct.grapic_data_struct.graphic_name[1] = 0;
    init_struct.grapic_data_struct.graphic_name[2] = 52;
    init_struct.grapic_data_struct.operate_tpye = op_type;
    init_struct.grapic_data_struct.graphic_tpye = 6;
    init_struct.grapic_data_struct.layer = 5;
    init_struct.grapic_data_struct.color = 8;
    init_struct.grapic_data_struct.start_x = AIM_CENTER_X + 150;
    init_struct.grapic_data_struct.start_y = AIM_CENTER_Y + 80;

    init_struct.grapic_data_struct.start_angle = 25; // font size
    init_struct.grapic_data_struct.end_angle = 0;
    init_struct.grapic_data_struct.width = 5;

    init_struct.grapic_data_struct.data =(int32_t)aim_dynamic.angle;
...
void draw_speed_cut(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    draw_init.grapic_data_struct.graphic_name[0] = 0;
    draw_init.grapic_data_struct.graphic_name[1] = 0;
    draw_init.grapic_data_struct.graphic_name[2] = 53;
    draw_init.grapic_data_struct.operate_tpye = op_type;
    draw_init.grapic_data_struct.graphic_tpye = 7;
    draw_init.grapic_data_struct.layer = 2;//图层怎么用
    draw_init.grapic_data_struct.color = 8;
    ...
    draw_init.grapic_data_struct.width = 2;
    draw_init.grapic_data_struct.start_x = AIM_CENTER_X + 150;
    draw_init.grapic_data_struct.start_y = AIM_CENTER_Y + 240;
    draw_init.grapic_data_struct.end_x = 0;
    draw_init.grapic_data_struct.end_y = 0;
    draw_init.grapic_data_struct.radius = 0;
    ...
    draw_init.grapic_data_struct.end_angle = 8; //锟街凤拷锟斤拷锟斤拷
    draw_init.data[0] = 'S';
    draw_init.data[1] = 'P';
    draw_init.data[2] = 'D';
    draw_init.data[3] = ' ';
...
void draw_speed_cut_number(uint16_t sender_id, uint16_t receiver_id, uint16_t op_type)
{
    ...
    init_struct.header_data_t.data_cmd_id = 0x0103;
    init_struct.header_data_t.sender_ID = sender_id;
    init_struct.header_data_t.receiver_ID = receiver_id;

    init_struct.grapic_data_struct.graphic_name[0] = 0;
    init_struct.grapic_data_struct.graphic_name[1] = 0;
    init_struct.grapic_data_struct.graphic_name[2] = 54;
    init_struct.grapic_data_struct.operate_tpye = op_type;
    init_struct.grapic_data_struct.graphic_tpye = 6;
    init_struct.grapic_data_struct.layer = 5;
    init_struct.grapic_data_struct.color = 4;
    init_struct.grapic_data_struct.start_x = AIM_CENTER_X + 150;
    init_struct.grapic_data_struct.start_y = AIM_CENTER_Y + 180;

    init_struct.grapic_data_struct.start_angle = 25; // font size
    init_struct.grapic_data_struct.end_angle = 0;
    init_struct.grapic_data_struct.width = 5;

    init_struct.grapic_data_struct.data = -speed_cut;
